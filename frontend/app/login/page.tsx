            ...
            <div className="bg-[#112F24]/70 border border-[#D4AF37]/15 rounded-3xl p-8 sm:p-10 backdrop-blur-2xl shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className="group relative w-full overflow-hidden rounded-2xl border border-[#D4AF37]/30 bg-gradient-to-r from-[#07241D]/90 via-[#0B3B2E]/90 to-[#07241D]/90 p-0.5 shadow-xl transition-all duration-500 hover:border-[#D4AF37] hover:shadow-[0_0_25px_rgba(212,175,55,0.25)] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  ...
                  <div className="relative flex items-center justify-between px-5 py-3.5 rounded-[14px] bg-[#0A261E]/95 backdrop-blur-xl">
                    <div className="flex items-center gap-3.5">
                      {/* Multi-color Google Vector Logo in Gold Ring Box */}
                      <div className="relative flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-[#07241D] border border-[#D4AF37]/40 shadow-inner group-hover:border-[#D4AF37] group-hover:scale-105 transition-all duration-300">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-sm font-semibold text-[#F5F0E6] group-hover:text-white transition-colors">
                    ...
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#112F24] border border-[#D4AF37]/30 text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-[#0B3B2E] group-hover:border-[#D4AF37] transition-all duration-300">
